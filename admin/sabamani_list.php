...
<html lang="en">
  <?php
	...
	if($_REQUEST['delete_id']!='' && $_REQUEST['delete_id'] > 0){
		$delete = deleterecord("sabamani", "id", $_REQUEST['delete_id']);
		if($delete==true){
			$message = DELETEMSG;
		}
	}
                ...
                <div class="x_panel">
				  ...
				  <form name="searach" method="get">
					...
					<tr>
						...
						<td><input type="submit" name="action" class="btn btn-success" value="Search" />
						<input type="button" name="actionreset" value="Reset" class="btn btn-success" onclick="document.location.href='sabamani_list.php'" /></td>
					...
					$totalquery = mysql_query("select * from sabamani where id!='' $searchquery");
					$select = mysql_query("select * from sabamani  where id!='' $searchquery order by id desc limit $start, $end");
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
					  ...
					  ?>
                        <tr>
                          ...
                          <td><a href="<?php echo $baseurl?>/add_sabamani.php?id=<?php echo $row['id']?>">Edit<a/> | 
						  <a href="<?php echo $baseurl?>/sabamani_list.php?delete_id=<?php echo $row['id']?>" onclick="return confirm('Are you sure want to delete?');">Delete<a/></td>
                        </tr>
					   <?php  $j++;}  ?>
