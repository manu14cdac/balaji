...
<html lang="en">
  <?php
	...
	if($_REQUEST['delete_id']!='' && $_REQUEST['delete_id'] > 0){
		$resultrow = single_row("home_setting", "id", $_REQUEST['delete_id']);
		@unlink("home_images/".$resultrow['image']);
		$delete = deleterecord("home_setting", "id", $_REQUEST['delete_id']);
		if($delete==true){
			$message = DELETEMSG;
		}
	}
          ...
          <div class="">
            ...
            <div class="row">
                ...
                <div class="x_panel">
				  ...
				  <form name="searach" method="get">
					...
					<tr>
						...
						<input type="button" name="actionreset" value="Reset" onclick="document.location.href='home_setting_list.php'" /></td>
					...
					$totalquery = mysql_query("select * from home_setting where id!='' $searchquery");
					
					$select = mysql_query("select * from home_setting  where id!='' $searchquery order by id desc limit $start, $end");
               ...
               <th>URL</th>
					  ...
					  ?>
                        <tr>
						  ...
						  <td><img src="<?php echo $baseurl.'/home_images/'.$row['image']?>" height="50px" width="50px" /></td>
              <td><?php echo $row['url']?></td>
                          ...
                          <td><a href="<?php echo $baseurl?>/add_home_setting.php?id=<?php echo $row['id']?>">Edit<a/> | <a href="<?php echo $baseurl?>/home_setting_list.php?delete_id=<?php echo $row['id']?>" onclick="return confirm('Are you sure want to delete?');">Delete<a/>
                        </tr>
					   <?php  $j++;}  ?>
					...
					<div class="pagination">	
								<?php
									...
									$reload = $baseurl."/home_setting_list.php";
