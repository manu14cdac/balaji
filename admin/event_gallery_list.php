              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form name="searach" method="get">
					...
					$totalquery = mysql_query("select * from event_gallery where id!='' $searchquery");
					$select = mysql_query("select * from event_gallery where id!='' $searchquery order by id desc limit $start, $end");
