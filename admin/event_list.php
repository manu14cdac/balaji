...
<html lang="en">
  <?php
	...
	if($_REQUEST['delete_id']!='' && $_REQUEST['delete_id'] > 0){
		$delete = deleterecord("event", "id", $_REQUEST['delete_id']);
		if($delete==true){
			$message = DELETEMSG;
		}
	}
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form name="searach" method="get">
					...
					$totalquery = mysql_query("select * from event where id!='' $searchquery");
					$select = mysql_query("select * from event where id!='' $searchquery order by id desc limit $start, $end");
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
					  ...
					  ?>
                        <tr>
                          ...
                          <td><a href="<?php echo $baseurl?>/add_event.php?id=<?php echo $row['id']?>">Edit<a/> | <a href="<?php echo $baseurl?>/event_list.php?delete_id=<?php echo $row['id']?>" onclick="return confirm('Are you sure want to delete?');">Delete<a/>
                        </tr>
					   <?php  $j++;}  ?>
