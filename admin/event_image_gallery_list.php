              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form name="searach" method="get">
					...
					$totalquery = mysql_query("SELECT * from event_gallery where id!='' $searchquery and gallery_type='photo'");
					$select = mysql_query("select * from event_gallery where id!='' $searchquery and gallery_type='photo' order by id desc limit $start, $end");
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
					  ...
					  ?>
                        <tr>
						  ...
						  <td>
						  <?php if($row['image']!='') { ?>
						  <img src="<?php echo $baseurl.'/gallery_images/'.$row['image']?>" height="50px" width="50px" />
						  <?php } ?>
						  </td>
						  <td><?php 
						  if($row['status']=='0'){
