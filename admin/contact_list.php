  ...
  <body class="nav-md">
    <div class="container body">
      ...
      <div class="right_col" role="main">
          ...
          $totalquery = mysql_query("SELECT * from contact where id!='' $searchquery");         
          $select = mysql_query("SELECT * from contact where id!='' $searchquery order by id desc limit $start, $end");
